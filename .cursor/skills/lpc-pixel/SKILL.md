...
description: >-
  ...
  spritesheet, paper-doll, character parts, hero.json, 玩家角色, or asks to
  build/re-render/swap character parts from a description or reference image.
